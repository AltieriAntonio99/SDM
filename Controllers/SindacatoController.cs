...
namespace SDM.Controllers
{
    public class SindacatoController : Controller
    {
        ...
        public ActionResult DownloadExcel()
        {
            ...
            string fileName = $"Pratiche_Sindacato_{DateTime.Now:yyyyMMddHHmmss}.xlsx";
            ...
            try
            {
                List<Pratica> pratiche = _help.PraticaSindacato(Convert.ToInt32(Session["idsede"].ToString()), Session["role"].ToString(), "getall", null);
