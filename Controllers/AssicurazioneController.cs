...
{
    public class AssicurazioneController : Controller
    {
        ...
        public ActionResult Index()
        {
            try
            {
                ...
                if (Session["username"] != null && Session["password"] != null)
                {
                    if (authentication.Login(Session["username"].ToString(), Session["password"].ToString(), Session["role"].ToString()))
                    {
                        ...
                        {
                            Pratiche = _help.PraticaAssicurazione(Convert.ToInt32(Session["idsede"].ToString()), Session["role"].ToString(), "getall", null),
                            Categorie = Session["role"].ToString() != "smartJob" ? _help.GetCategorie("Assicurazione") : _help.GetCategorie("AssicurazioneSmartJob")
                        };
            ...
            {
                _logger.LogWrite("AssicurazioneController", null, ex);
            ...
            try
            {
                ...
                if (Session["username"] != null && Session["password"] != null)
                {
                    if (authentication.Login(Session["username"].ToString(), Session["password"].ToString(), Session["role"].ToString(), true))
                    {
                        ...
                        {
                            SottocategoriaList = Session["role"].ToString() != "smartJob" ? _help.GetCategorie("Assicurazione") : _help.GetCategorie("AssicurazioneSmartJob")
                        };
            ...
            try
            {
                ...
                if (Session["username"] != null && Session["password"] != null)
                {
                    if (authentication.Login(Session["username"].ToString(), Session["password"].ToString(), Session["role"].ToString(), true))
                    {
                        ...
                        Pratica model = _help.PraticaAssicurazione(idPratica, "get");
                        model.SottocategoriaList = Session["role"].ToString() != "smartJob" ? _help.GetCategorie("Assicurazione") : _help.GetCategorie("AssicurazioneSmartJob");
        ...
        public ActionResult SavePratica(Pratica pratica)
        {
            try
            {
                ...
                if (_help.ControlloCampi(pratica))
                {
                    ...
                    if (_help.PraticaAssicurazione(pratica, "save"))
                    {
                        TempData["erroreInserimentoPatronatoHome"] = "Pratica salvata correttamente";
                        return RedirectToAction("Index", "Assicurazione");
                    }
                }

                TempData["erroreInserimentoPatronato"] = "true";
                return RedirectToAction("AggiungiPratica", "Assicurazione");
            }
            catch (Exception ex)
            {
                _logger.LogWrite("AssicurazioneController", null, ex);
        ...
        public ActionResult EditPratica(Pratica pratica)
        {
            try
            {
                if (_help.ControlloCampi(pratica))
                {
                    ...
                    if (_help.PraticaAssicurazione(pratica, "update"))
                    {
                ...
                TempData["erroreInserimentoPatronato"] = "true";
                return RedirectToAction("ModificaPratica", "Assicurazione", new { idPratica = pratica.Id });
            }
            catch (Exception ex)
            {
                _logger.LogWrite("AssicurazioneController", null, ex);
        ...
        public ActionResult DeletePratica(int idPratica)
        {
            try
            {
                ...
                PraticaIndex model = new PraticaIndex();
                if (_help.DeleteAssicurazione(idPratica))
                {
                    model.Pratiche = _help.PraticaAssicurazione(Convert.ToInt32(Session["idsede"].ToString()), Session["role"].ToString(), "getall", null);
        ...
        public ActionResult SearchPratica(Pratica pratica)
        {
            ...
            {
                pratica.IdSede = Convert.ToInt32(Session["idsede"].ToString());
                List<Pratica> result = _help.PraticaAssicurazione(0, Session["role"].ToString(), "search", pratica);
            ...
            try
            {
                ...
                if (Session["username"] != null && Session["password"] != null)
                {
                    if (authentication.Login(Session["username"].ToString(), Session["password"].ToString(), Session["role"].ToString(), true))
                    {
                        ...
                        List<Attachment> model = _help.AttachmentsAssicurazione(idPratica, "getall");
                        return View(model);
                    }
                    else { return RedirectToAction("ErrorAuth", "Home"); }
                }
        ...
        public ActionResult UploadFile(int id, List<HttpPostedFileBase> files)
        {
            try
            {
                ...
                if (Request.Files != null && Request.Files.Count > 0 && Request.Files.Count <= 4)
                {
                    ...
                    if (ListFile.Count > 0)
                    {
                        if (!_help.AttachmentsAssicurazione(ListFile, "upload"))
                        {
                ...
                List<Attachment> model = _help.AttachmentsAssicurazione(id, "getall");
        ...
        public ActionResult DownloadFile(int idFile)
        {
            try
            {
                Attachment loadFile = _help.AttachmentsAssicurazione("download", idFile);
        ...
        public ActionResult DeleateFile(int idPratica, int idFile)
        {
            try
            {
                ...
                if (_help.DeleteFileAssicurazione(idFile))
                {
                    model = _help.AttachmentsAssicurazione(idPratica, "getall");
                    return PartialView("TableAllegati", model);
                }
        ...
        public ActionResult DownloadExcel()
        {
            ...
            string fileName = $"Pratiche_Assicurazione_{DateTime.Now:yyyyMMddHHmmss}.xlsx";
            ...
            try
            {
                List<Pratica> pratiche = _help.PraticaAssicurazione(Convert.ToInt32(Session["idsede"].ToString()), Session["role"].ToString(), "getall", null);
