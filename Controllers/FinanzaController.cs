...
namespace SDM.Controllers
{
    public class FinanzaController : Controller
    {
        ...
        public ActionResult Index()
        {
            try
            {
                ...
                if (Session["username"] != null && Session["password"] != null)
                {
                    if (authentication.Login(Session["username"].ToString(), Session["password"].ToString(), Session["role"].ToString()))
                    {
                        ...
                        {
                            Pratiche = _help.PraticaFinanza(Convert.ToInt32(Session["idsede"].ToString()), Session["role"].ToString(), "getall", null),
                            Categorie = null
                        };
            ...
            {
                _logger.LogWrite("FinanzaController", null, ex);
            ...
            try
            {
                ...
                if (Session["username"] != null && Session["password"] != null)
                {
                    if (authentication.Login(Session["username"].ToString(), Session["password"].ToString(), Session["role"].ToString(), true))
                    {
                        ...
                        Pratica model = _help.PraticaFinanza(idPratica, "get");
        ...
        public ActionResult SavePratica(Pratica pratica)
        {
            try
            {
                ...
                if (_help.ControlloCampiNoCategoria(pratica))
                {
                    ...
                    if (_help.PraticaFinanza(pratica, "save"))
                    {
                        TempData["erroreInserimentoPatronatoHome"] = "Pratica salvata correttamente";
                        return RedirectToAction("Index", "Finanza");
                    }
                }

                TempData["erroreInserimentoPatronato"] = "true";
                return RedirectToAction("AggiungiPratica", "Finanza");
            }
            catch (Exception ex)
            {
                _logger.LogWrite("FinanzaController", null, ex);
        ...
        public ActionResult EditPratica(Pratica pratica)
        {
            try
            {
                if (_help.ControlloCampiNoCategoria(pratica))
                {
                    ...
                    if (_help.PraticaFinanza(pratica, "update"))
                    {
                ...
                TempData["erroreInserimentoPatronato"] = "true";
                return RedirectToAction("ModificaPratica", "Finanza", new { idPratica = pratica.Id });
            }
            catch (Exception ex)
            {
                _logger.LogWrite("FinanzaController", null, ex);
        ...
        public ActionResult DeletePratica(int idPratica)
        {
            try
            {
                ...
                PraticaIndex model = new PraticaIndex();
                if (_help.DeleteFinanza(idPratica))
                {
                    model.Pratiche = _help.PraticaFinanza(Convert.ToInt32(Session["idsede"].ToString()), Session["role"].ToString(), "getall", null);
        ...
        public ActionResult SearchPratica(Pratica pratica)
        {
            ...
            {
                pratica.IdSede = Convert.ToInt32(Session["idsede"].ToString());
                List<Pratica> result = _help.PraticaFinanza(0, Session["role"].ToString(), "search", pratica);
            ...
            try
            {
                ...
                if (Session["username"] != null && Session["password"] != null)
                {
                    if (authentication.Login(Session["username"].ToString(), Session["password"].ToString(), Session["role"].ToString(), true))
                    {
                        ...
                        List<Attachment> model = _help.AttachmentsFinanza(idPratica, "getall");
                        return View(model);
                    }
                    else { return RedirectToAction("ErrorAuth", "Home"); }
                }
        ...
        public ActionResult UploadFile(int id, List<HttpPostedFileBase> files)
        {
            try
            {
                ...
                if (Request.Files != null && Request.Files.Count > 0 && Request.Files.Count <= 4)
                {
                    ...
                    if (ListFile.Count > 0)
                    {
                        if (!_help.AttachmentsFinanza(ListFile, "upload"))
                        {
                ...
                List<Attachment> model = _help.AttachmentsFinanza(id, "getall");
        ...
        public ActionResult DownloadFile(int idFile)
        {
            try
            {
                Attachment loadFile = _help.AttachmentsFinanza("download", idFile);
        ...
        public ActionResult DeleateFile(int idPratica, int idFile)
        {
            try
            {
                ...
                if (_help.DeleteFileFinanza(idFile))
                {
                    model = _help.AttachmentsFinanza(idPratica, "getall");
                    return PartialView("TableAllegati", model);
                }
        ...
        public ActionResult DownloadExcel()
        {
            ...
            string fileName = $"Pratiche_Finanza_{DateTime.Now:yyyyMMddHHmmss}.xlsx";
            ...
            try
            {
                List<Pratica> pratiche = _help.PraticaFinanza(Convert.ToInt32(Session["idsede"].ToString()), Session["role"].ToString(), "getall", null);
