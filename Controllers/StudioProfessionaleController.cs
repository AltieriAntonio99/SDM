...
namespace SDM.Controllers
{
    public class StudioProfessionaleController : Controller
    {
        ...
        public ActionResult DownloadExcel()
        {
            ...
            string fileName = $"Pratiche_Studio_Professionale_{DateTime.Now:yyyyMMddHHmmss}.xlsx";
            ...
            try
            {
                List<Pratica> pratiche = _help.PraticaStudioProfessionale(Convert.ToInt32(Session["idsede"].ToString()), Session["role"].ToString(), "getall", null);
