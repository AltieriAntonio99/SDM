...
namespace SDM.Controllers
{
    public class CreditoController : Controller
    {
        ...
        public ActionResult Index()
        {
            try
            {
                ...
                if (Session["username"] != null && Session["password"] != null)
                {
                    if (authentication.Login(Session["username"].ToString(), Session["password"].ToString(), Session["role"].ToString()))
                    {
                        ...
                        {
                            Pratiche = _help.PraticaCredito(Convert.ToInt32(Session["idsede"].ToString()), Session["role"].ToString(), "getall", null),
                            Categorie = Session["role"].ToString() != "smartJob" ? _help.GetCategorie("Credito") : _help.GetCategorie("CreditoSmartJob")
                        };
            ...
            {
                _logger.LogWrite("CreditoController", null, ex);
            ...
            try
            {
                ...
                if (Session["username"] != null && Session["password"] != null)
                {
                    if (authentication.Login(Session["username"].ToString(), Session["password"].ToString(), Session["role"].ToString(), true))
                    {
                        ...
                        {
                            SottocategoriaList = Session["role"].ToString() != "smartJob" ? _help.GetCategorie("Credito") : _help.GetCategorie("CreditoSmartJob")
                        };
            ...
            try
            {
                ...
                if (Session["username"] != null && Session["password"] != null)
                {
                    if (authentication.Login(Session["username"].ToString(), Session["password"].ToString(), Session["role"].ToString(), true))
                    {
                        ...
                        Pratica model = _help.PraticaCredito(idPratica, "get");
                        model.SottocategoriaList = Session["role"].ToString() != "smartJob" ? _help.GetCategorie("Credito") : _help.GetCategorie("CreditoSmartJob");
        ...
        public ActionResult SavePratica(Pratica pratica)
        {
            try
            {
                ...
                if (_help.ControlloCampi(pratica))
                {
                    ...
                    if (_help.PraticaCredito(pratica, "save"))
                    {
                ...
                return RedirectToAction("AggiungiPratica", "Credito");
            }
            catch (Exception ex)
            {
                _logger.LogWrite("CreditoController", null, ex);
        ...
        public ActionResult EditPratica(Pratica pratica)
        {
            try
            {
                if (_help.ControlloCampi(pratica))
                {
                    ...
                    if (_help.PraticaCredito(pratica, "update"))
                    {
                ...
                TempData["erroreInserimentoPatronato"] = "true";
                return RedirectToAction("ModificaPratica", "Credito", new { idPratica = pratica.Id });
            }
            catch (Exception ex)
            {
                _logger.LogWrite("CreditoController", null, ex);
        ...
        public ActionResult DeletePratica(int idPratica)
        {
            try
            {
                ...
                PraticaIndex model = new PraticaIndex();
                if (_help.DeleteCredito(idPratica))
                {
                    model.Pratiche = _help.PraticaCredito(Convert.ToInt32(Session["idsede"].ToString()), Session["role"].ToString(), "getall", null);
        ...
        public ActionResult SearchPratica(Pratica pratica)
        {
            ...
            {
                pratica.IdSede = Convert.ToInt32(Session["idsede"].ToString());
                List<Pratica> result = _help.PraticaCredito(0, Session["role"].ToString(), "search", pratica);
            ...
            try
            {
                ...
                if (Session["username"] != null && Session["password"] != null)
                {
                    if (authentication.Login(Session["username"].ToString(), Session["password"].ToString(), Session["role"].ToString(), true))
                    {
                        ...
                        List<Attachment> model = _help.AttachmentsCredito(idPratica, "getall");
                        return View(model);
                    }
                    else { return RedirectToAction("ErrorAuth", "Home"); }
                }
        ...
        public ActionResult UploadFile(int id, List<HttpPostedFileBase> files)
        {
            try
            {
                ...
                if (Request.Files != null && Request.Files.Count > 0 && Request.Files.Count <= 4)
                {
                    ...
                    if (ListFile.Count > 0)
                    {
                        if (!_help.AttachmentsCredito(ListFile, "upload"))
                        {
                ...
                List<Attachment> model = _help.AttachmentsCredito(id, "getall");
        ...
        public ActionResult DownloadFile(int idFile)
        {
            try
            {
                Attachment loadFile = _help.AttachmentsCredito("download", idFile);
        ...
        public ActionResult DeleateFile(int idPratica, int idFile)
        {
            try
            {
                ...
                if (_help.DeleteFileCredito(idFile))
                {
                    model = _help.AttachmentsCredito(idPratica, "getall");
                    return PartialView("TableAllegati", model);
                }
        ...
        public ActionResult DownloadExcel()
        {
            ...
            string fileName = $"Pratiche_Credito_{DateTime.Now:yyyyMMddHHmmss}.xlsx";
            ...
            try
            {
                List<Pratica> pratiche = _help.PraticaCredito(Convert.ToInt32(Session["idsede"].ToString()), Session["role"].ToString(), "getall", null);
